...
const Theme = ({ theme, onChange }: { theme: string; onChange: (value: string) => void }) => {
  ...
  return (
    <button
      className="cursor-pointer flex items-center gap-2 rounded-2xl p-2 transition-colors hover:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
      aria-label={label}
