  ...
  return (
    <>
      ...
      {startupConfig?.emailLoginEnabled === true && (
        <h1 className='mb-4 text-center text-3xl font-semibold text-gray-900 dark:text-gray-100'>Создать аккаунт</h1>
      )}
      ...
      {!startupConfigError && !isFetching && (
        <>
          ...
          <p className="my-4 text-center text-sm font-medium text-gray-500 dark:text-gray-400">
            {localize('com_auth_already_have_account')}{' '}
            <a
              href="/login"
              aria-label="Login"
              className="inline-flex p-1 underline underline-offset-4 text-sm font-medium text-gray-800 transition-colors duration-300 hover:text-gray-500 dark:text-gray-50 dark:hover:text-gray-300"
            >
