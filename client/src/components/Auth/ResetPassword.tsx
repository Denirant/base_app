...
function ResetPassword() {
  ...
  if (resetPassword.isSuccess) {
    return (
      <>
        <div
          className="relative mb-8 mt-4 rounded-3xl border border-blue-400 bg-blue-100 px-4 py-3 text-center text-blue-700 dark:bg-gray-900 dark:text-white"
          role="alert"
        >
        ...
        <button
          ...
          className="mx-auto w-4/5 rounded-2xl bg-gray-800 px-4 py-3 text-sm font-medium text-white transition-colors duration-200 hover:bg-gray-600 dark:bg-gray-50 dark:text-gray-700 dark:hover:bg-gray-200/90 dark:hover:text-gray-900"
        >
  ...
  return (
    ...
    >
      <div className="mb-3">
        <h1 className="mb-4 text-center text-3xl font-semibold text-gray-900 dark:text-gray-100">
          Новый пароль
        </h1>
      ...
      <div className="ml-auto mr-auto mt-6 w-4/5">
        <button
